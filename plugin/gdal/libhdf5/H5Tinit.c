// changed to be generated based on U++ configuration
...
#define CPU_ORDER H5T_ORDER_LE
#else
#define CPU_ORDER H5T_ORDER_BE
#endif
...
H5TN_init_interface(void)
{
    ...
    */
    ...
    dt->shared->size = sizeof(signed char);
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(signed char);
    ...
    */
    ...
    dt->shared->state = H5T_STATE_IMMUTABLE;
    dt->shared->type = H5T_INTEGER;
    dt->shared->size = sizeof(unsigned char);
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(unsigned char);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    ...
    */
    ...
    dt->shared->state = H5T_STATE_IMMUTABLE;
    dt->shared->type = H5T_INTEGER;
    dt->shared->size = sizeof(short);
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(short);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_2;
    ...
    */
    ...
    dt->shared->state = H5T_STATE_IMMUTABLE;
    dt->shared->type = H5T_INTEGER;
    dt->shared->size = sizeof(unsigned short);
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(unsigned short);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_NONE;
    ...
    */
    ...
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(int);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_2;
    ...
    */
    ...
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(unsigned int);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_NONE;
    ...
    */
    ...
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(long);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_2;
    ...
    */
    ...
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(unsigned long);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_NONE;
    ...
    */
    ...
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(long long);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_2;
    ...
    */
    ...
    dt->shared->u.atomic.order = CPU_ORDER;
    dt->shared->u.atomic.offset = 0;
    dt->shared->u.atomic.prec = 8 * sizeof(unsigned long long);
    dt->shared->u.atomic.lsb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.msb_pad = H5T_PAD_ZERO;
    dt->shared->u.atomic.u.i.sign = H5T_SGN_NONE;
